...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/home/tonton/{id}', [HomeController::class, 'tonton'])->name('home.tonton');
});

Route::middleware(['admin', 'auth', 'verified'])->group(function () {
    Route::resource('film', ListfilmController::class);
    Route::resource('admin', AdminController::class);
    Route::resource('table', CatergoryController::class);
});
